...
public class Game {
    ...
    public int InifiniteChasms()
    {

        Random generator = new Random();
        int infiniteChasm = generator.nextInt(19);
        return infiniteChasm;

    }

    public int SleepDeadStudent()
    {
        Random comundead = new Random();
        int sleepdead = comundead.nextInt(19);
        return sleepdead;
    }
    ...
    {
        currentState = rooms.get(currentState).move(option);
    }
